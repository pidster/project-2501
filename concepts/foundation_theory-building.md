...
**For AI-augmented development**: Naur wrote in 1985, before modern AI existed. His concept of "theory" was defined in terms of human cognition—the explanatory understanding in programmers' minds that enables intelligent modification. Whether AI systems develop anything functionally analogous to theory remains an open question. What is clear: AI produces artifacts, and humans must build theory about those artifacts (whether AI-generated or human-generated) to maintain and modify systems intelligently. This suggests that AI-augmented development requires deliberate human engagement to build understanding, not just acceptance of outputs. Through dialogue—reviewing AI outputs, questioning decisions, iterating on designs—humans build theory even when AI generates initial artifacts.
...
- **Skill Degradation Research**: Bainbridge (1983) provides complementary evidence from cognitive engineering: beyond theory (conceptual understanding), practical skills also degrade without use. Operators who monitor automated systems lose the manual and cognitive skills needed for emergency intervention. This supports the principle that human engagement must be preserved not only for theory-building but for skill maintenance.
...
- [**Actor Model**](./concept_actor-model.md): Humans build theory through engagement with problems. Whether AI develops analogous understanding is contested. What matters for practice: humans must build theory about the systems they maintain, regardless of whether code is human-generated or AI-generated. This shapes collaboration design—human engagement at theory-building moments (design decisions, modification judgements) preserves understanding even when AI assists with artifact production.
