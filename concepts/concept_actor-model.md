...
- [**Transactive Memory Systems**](./foundation_transactive-memory.md): Wegner (1986) defined TMS for human groups. AI participates asymmetrically—as a queryable knowledge source rather than a full social participant. How AI integrates with human TMS is an emerging area.
